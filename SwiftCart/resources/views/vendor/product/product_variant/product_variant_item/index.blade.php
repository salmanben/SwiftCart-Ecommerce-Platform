...
@section('content')
    <section class="section">
        ...
        <div class="section-body my-4 container-fluid">
            <a href="{{ route('vendor.product_variant.index', ['id' => $product_variant->product->id]) }}"
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href = "{{ route('vendor.product_variant_item.create', ['variant_id' => $product_variant->id]) }}"
    ...
    @push('scripts')
        ...
        <script>
            function switch_status(event) {
                ...
                var url = "{{ route('vendor.product_variant_item.switch_status') }}"
                fetch(url, {
                        method: 'PUT',
                        body: JSON.stringify({
                            id: id,
