...
@section('content')
    <section class="section">
        ...
        <div class="section-body my-4 container-fluid">
            <a href="{{ route('vendor.product_variant.index', ['id' => $product_variant->product_id]) }}"
            ...
            <div class="card col-12 col-md-6">
                ...
                <div class="card-body">
                    <form action="{{ route('vendor.product_variant.update', $product_variant->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label class="">Name</label>
                            <input type="text" class="form-control shadow-none" name="name"
                                value = "{{ $product_variant->name }}" placeholder="name" id="">
                            @error('name')
