...
@section('content')
    <section>
        <h3 class="shadow-sm bg-white ps-4 py-3"><i class="fa-solid fa-user me-2"></i>Profile</h3>
        <div class="section-body container-fluid my-4">
            <div class="card col-12 col-md-7 mb-4">
                <div class="card-header">
                    <h5 class="fw-normal">Update Profile</h5>
                </div>
                <div class="card-body">
                    <form method="Post" action="{{ route('vendor.update_profile') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
