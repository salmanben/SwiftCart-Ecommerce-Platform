...
<section class="section">
    ...
    <div class="section-body my-4 container-fluid">
        ...
        <a href="{{route('admin.product_variant_item.index', ['variant_id'=>$product_variant_item->product_variant_id])}}"  class="btn btn-info mb-3 ml-3">
        ...
        <div class="card col-12 col-md-6">
          ...
          <div class="card-body">
            <form action="{{ route('admin.product_variant_item.update', $product_variant_item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="mb-3">
