...
<section class="section">
    ...
    <div class="section-body my-4 container-fluid">
        <a href="{{route('admin.product_variant_item.index', ['variant_id'=>$product_variant->id])}}"  class="btn btn-info mb-3 ml-3">
        ...
        <div class="card col-12 col-md-6">
          ...
          <div class="card-body">
            <form action="{{ route('admin.product_variant_item.store') }}" method="post">
                @csrf
                <div class="mb-3">
                    <label class="">Variant Name</label>
                    <input type="text" readonly class=" form-control shadow-none"  name="variant_name" value = "{{$product_variant->name}}"
                    placeholder="variant name" id="">
                </div>
                <div class="mb-3">
                    <label class="">Variant Item</label>
                    <input type="text"  class=" form-control shadow-none"  name="item_name" value = "{{old('item_name')}}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text"  class=" form-control shadow-none"  name="price" value = "{{old('price')}}"
