...
class ProductImageGalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            {
                $delete = '<a onclick="delete_row(event)" href="'.route("admin.product_image_gallery.destroy",$query->id).'" id="' . $query->id . '"
            ...
            {
                return '<img width=80 src="'.asset("storage/upload/".$query->image).'" alt="banner">';
            })
