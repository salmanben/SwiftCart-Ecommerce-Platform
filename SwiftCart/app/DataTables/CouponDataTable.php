...
class CouponDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        {
            $edit = '<a  href="'.route("admin.coupon.edit",$query->id).'" class="btn btn-primary mb-1"><i class="fa-solid fa-pen-to-square"></i></a>';
            $delete = '<a onclick="delete_row(event)" href="'.route("admin.coupon.destroy",$query->id).'" id="' . $query->id . '"
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('max_use')->addClass('text-center'),
