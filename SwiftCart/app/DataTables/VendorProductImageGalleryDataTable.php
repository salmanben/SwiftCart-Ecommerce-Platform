...
class VendorProductImageGalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            {
                $delete = '<a onclick="delete_row(event)" href="'.route("vendor.product_image_gallery.destroy",$query->id).'" id="' . $query->id . '"
            ...
            {
                return '<img width=100 src="'.asset("storage/upload/".$query->image).'" alt="banner">';
            })
