...
class ProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        {
            $edit = '<a href="'.route("admin.product_variant_item.edit",$query->id).'" class="btn btn-primary mb-1"><i class="fa-solid fa-pen-to-square"></i></a>';
            $delete = '<a onclick="delete_row(event)" href="'.route("admin.product_variant_item.destroy",$query->id).'" id="' . $query->id . '"
