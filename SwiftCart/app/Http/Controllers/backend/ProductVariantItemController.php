...
class ProductVariantItemController extends Controller
{
    ...
    public function index(Request $request, ProductVariantItemDataTable $datatable)
    {
        ...
        return $datatable->render('admin.product.product_variant.product_variant_item.index', compact('product_variant'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.product.product_variant.product_variant_item.create', compact('product_variant'));
    }
    ...
    public function edit(String $id)
    {
        ...
        return view('admin.product.product_variant.product_variant_item.edit', compact('product_variant_item'));
    }
    ...
    public function update(Request $request, String $variant_id)
    {
        ...
        return redirect()->route('admin.product_variant_item.index',['variant_id'=>$request->product_variant_id]);
    }
