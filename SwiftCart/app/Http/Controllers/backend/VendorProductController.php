...
class VendorProductController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('vendor.product.edit', compact('product', 'brands', 'categories', 'sub_categories', 'child_categories'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($product->order_products != null && $product->order_products->count() > 0)
            return response(['status'=>'error', 'message'=>'You can\'t delete this product.']);
